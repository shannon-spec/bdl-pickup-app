...
const DARK_CTRL =
  "border border-white/15 bg-white/10 text-white/80 hover:text-white hover:bg-[rgba(13,139,255,0.24)] hover:border-[rgba(13,139,255,0.50)] transition-colors";
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  "hover:bg-[rgba(13,139,255,0.24)] hover:text-white",
                  isActive
                    ? "bg-[rgba(13,139,255,0.26)] text-white"
                    : "text-white/55",
