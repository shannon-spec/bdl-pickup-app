...
function RangeTabs({
  ...
  return (
    <div className="inline-flex rounded-full bg-[color:var(--surface-2)] p-0.5 self-start">
      {(["MTD", "YTD"] as const).map((r) => {
        ...
        return (
          <button
            ...
            type="button"
            onClick={() => onChange(r)}
            className={`px-3 h-7 rounded-full text-[10.5px] font-bold tracking-[0.12em] uppercase transition-colors ${
              active
