      ...
      {hasPlayer && (
        <div className="inline-flex items-center gap-2 flex-shrink-0 max-sm:w-full">
          ...
          <Link
            ...
            className="relative inline-flex items-center gap-1.5 h-9 px-3.5 rounded-full bg-[color:var(--brand)] hover:bg-[color:var(--brand-hover)] text-white text-[11.5px] font-bold tracking-[0.04em] uppercase shadow-[var(--cta-shadow)] transition-colors max-sm:flex-1 max-sm:justify-center"
          >
